...
import ad1 from "../../assets/2sp.png";
import ad2 from "../../assets/ad6.jpeg";
import ad3 from "../../assets/tp12.jpg";
import ad4 from "../../assets/tp12.jpg";
...
const Product = () => {
  ...
  useEffect(() => {
    strapi.get("products", { id }).then((res) => {
      console.log("Data: ", { id: res.data.id, ...res.data.attributes });
      setProduct({ id: res.data.id, ...res.data.attributes });
    });
            ...
            {displaySection === "main" && (
              <div className="product-right-container">
                ...
                >
                  <Link
                    to="/home"
                    style={{ textDecoration: "none", color: "#3B67AF" }}
                  >
                    Home
                  </Link>
                  <p>{">"}</p>
                ...
                <div className="modal-container">
                  <div className="modal-img">
                    ...
                    <img
                      ...
                      src={strapi.getImageURL(product.img)}
                      alt=""
                    />
                  </div>
                  <div className="modal-content">
                    ...
                    <div className="modal-content2">
                      <p> ✓ In Stock</p>
                      <p>
                        <span>CATEGORY:</span> {product.subCategory}
                      </p>
                    </div>
                    <div className="modal-content2">
                      <p>
                    ...
                    <p style={{ color: "gold" }}>{product.ratings}</p>
                    ...
                    <div className="modal-cart-container">
                      ...
                      <AddToCartBtn
                        id={id}
                        quantity={value} /* id={id} quantity={quantity} */
                      />
