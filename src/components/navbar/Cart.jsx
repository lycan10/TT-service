...
const Cart = ({ mobile }) => {
  ...
  const openCart = () => {
    ...
    trackClickEvent('Button', 'Click', 'Cart Open Button Clicked');
  ...
  const closeCart = () => {
    ...
    trackClickEvent('Button', 'Click', 'Cart Close Button Clicked');
              ...
              <div className="shopping-cart-dropdown-cart-quantity">
                ...
                <div className="shopping-cart-dropdown-cart-amount">
                  ...
                  <h2>
                    {" "}
                    $
                    {((cart[0]?.price?.slice(1) || 0) * cart.length).toFixed(2)}
                  </h2>
                </div>
              </div>
              <div
