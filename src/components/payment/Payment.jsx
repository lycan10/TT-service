...
const Payment = () => {
  ...
  const [shipping, setShipping] = useState({ amount: 0, provider: "none" });
  ...
  useEffect(() => console.log(shipping), [shipping]);
  ...
  const handleOptionChange = (event) => {
    ...
    switch (event.target.value) {
      case "Pickup":
        setShipping({ amount: 0, provider: "none" });
        break;
      case "Regular":
        setShipping(shippingData.regular); // Set the default shipping cost or update as needed
        break;
      case "Express":
        setShipping(shippingData.express); // Update with the desired cost for express shipping
        break;
      default:
        setShipping(shippingData.regular); // Default shipping cost
        break;
    }
  };
  ...
  const navigateToCheckout = () => {
    ...
    trackClickEvent('Button', 'Click', 'checkout Button Clicked');
            ...
            <div className="checkout-shipping-address">
              ...
              <div className="checkout-payment-options">
                ...
                <p style={{ marginTop: "0.5rem" }}>
                  ...
                  {shipping.provider === "none" ? "" : `(${shipping.provider})`}
                </p>
              </div>
              <form
              ...
              >
                ...
                <button
                  disabled={loading || token || paymentError ? false : true}
